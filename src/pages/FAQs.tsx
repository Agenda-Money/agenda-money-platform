...
const faqSections = [
  {
    ...
    items: [
      ...
      { q: "When did Agenda Money start?", a: "We have been operating since June 2025." },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What is the interest rate?", a: "Transparent pricing at 0.5% per day. For example, if you borrow GHS 300 for 14 days, your total repayment is GHS 321. No hidden charges." },
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            <div className="relative rounded-[3rem] lg:rounded-[4rem] overflow-hidden aspect-[4/3] shadow-2xl border-4 lg:border-8 border-white/10">
              <img src={faqImg} alt="Agenda Money Support" className="w-full h-full object-cover" loading="lazy" />
