...
const steps = [
  ...
  { num: "04", title: "Instant Disbursement", desc: "Funds hit your MoMo wallet (MTN, Telecel, or AT) immediately upon approval — 24/7.", icon: HandCoins, color: "text-secondary", bg: "bg-secondary/10" },
];
